...
const DATE: &str = "Transaction date";
const TRANSACTION: &str = "Transaction";
const NAME: &str = "Name";
const MEMO: &str = "Memo";
const AMOUNT: &str = "Amount";
const DATETIME_FORMAT: &str = "%m/%d/%Y";
pub static TANGERINE_CREDIT_HEADERS: &[&str] = &[DATE, TRANSACTION, NAME, MEMO, AMOUNT];

pub struct TangerineCreditRecordParser {
    generic_record_parser: GenericRecordParser,
}

impl Default for TangerineCreditRecordParser {
    fn default() -> TangerineCreditRecordParser {
        ...
        TangerineCreditRecordParser {
            generic_record_parser: parser,
        }
    }
}

impl TangerineCreditRecordParser {
...
impl TransactionParser for TangerineCreditRecordParser {
